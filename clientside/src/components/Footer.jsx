...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-slate-800 via-slate-700 to-teal-700 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Diapers Store</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <span className="text-sm">info@diapersstore.qa</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            2024 Diapers Store. All rights reserved. • 
            <button 
